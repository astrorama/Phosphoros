...
public:
   ...
   */
  static std::list<std::string> getCompatibleCorrectionFiles(std::string            catalog,
  ...
  GetConfigurationMap(std::map<std::string, boost::program_options::variable_value> run_option, std::string catalog,
